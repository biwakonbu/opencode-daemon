...
struct OpenCodeSession: Codable, Identifiable {
    ...
    init(id: String = UUID().uuidString, slug: String = "", version: String = "", projectID: String = "", directory: String = "", title: String = "", created: Int64 = 0, updated: Int64 = 0, isActive: Bool = true) {
        self.id = id
        self.slug = slug
